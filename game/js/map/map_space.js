...
let marker8 = document.getElementById("marker-8");
let marker8_pos = marker8.getBoundingClientRect();

let marker9 = document.getElementById("marker-9");
let marker9_pos = marker9.getBoundingClientRect();
...
container.addEventListener("mousemove", function(e) {
    if (dragging) {
        ...
        marker8.style.top = marker8_pos.top + (mapY + deltaY) + "px";
        marker8.style.left = marker8_pos.left + (mapX + deltaX) + "px";

        marker9.style.top = marker9_pos.top + (mapY + deltaY) + "px";
        marker9.style.left = marker9_pos.left + (mapX + deltaX) + "px";

        marker10.style.top = marker10_pos.top + (mapY + deltaY) + "px";
        marker10.style.left = marker10_pos.left + (mapX + deltaX) + "px";
